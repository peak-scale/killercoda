...
SOPS is an editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats and encrypts with AWS KMS, GCP KMS, Azure Key Vault, age, and PGP. ([demo](https://www.youtube.com/watch?v=YTEVyLXFiq0)). The [SOPS-Operator](https://github.com/peak-scale/sops-operator) allows to directly apply SOPS-encrypted manifests to the Kubernetes API. It also brings Decryption-Key Management to the Kubernetes API.
